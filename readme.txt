...
3. Open "http://mason.gmu.edu/~kdonapat/index" for login page
4. Open "http://mason.gmu.edu/~kdonapat/home-page.html" for Homepage
5. Open "http://mason.gmu.edu/~kdonapat/registration.html" for Registration
